...
${OBJECTDIR}/lua/lfs.o: lua/lfs.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lua/lfs.o lua/lfs.c
...
${OBJECTDIR}/src/game_engine_joystick.o: src/game_engine_joystick.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_joystick.o src/game_engine_joystick.cpp

${OBJECTDIR}/src/game_engine_collision.o: src/game_engine_collision.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_collision.o src/game_engine_collision.cpp

${OBJECTDIR}/src/game_engine_view.o: src/game_engine_view.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_view.o src/game_engine_view.cpp
...
${OBJECTDIR}/src/player_paddle.o: src/player_paddle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/player_paddle.o src/player_paddle.cpp
...
${OBJECTDIR}/sdl_gfx/SDL_gfxBlitFunc.o: sdl_gfx/SDL_gfxBlitFunc.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sdl_gfx/SDL_gfxBlitFunc.o sdl_gfx/SDL_gfxBlitFunc.c

${OBJECTDIR}/src/ui/main_menu_ui.o: src/ui/main_menu_ui.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ui/main_menu_ui.o src/ui/main_menu_ui.cpp
...
${OBJECTDIR}/src/game_math.o: src/game_math.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_math.o src/game_math.cpp
...
${OBJECTDIR}/src/pong_ball.o: src/pong_ball.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pong_ball.o src/pong_ball.cpp

${OBJECTDIR}/src/game_engine_resource.o: src/game_engine_resource.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_resource.o src/game_engine_resource.cpp

${OBJECTDIR}/sdl_gfx/SDL_rotozoom.o: sdl_gfx/SDL_rotozoom.c 
	${MKDIR} -p ${OBJECTDIR}/sdl_gfx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sdl_gfx/SDL_rotozoom.o sdl_gfx/SDL_rotozoom.c
...
${OBJECTDIR}/src/lua_object.o: src/lua_object.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lua_object.o src/lua_object.cpp

${OBJECTDIR}/sdl_gfx/SDL_framerate.o: sdl_gfx/SDL_framerate.c 
	${MKDIR} -p ${OBJECTDIR}/sdl_gfx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sdl_gfx/SDL_framerate.o sdl_gfx/SDL_framerate.c

${OBJECTDIR}/src/game_engine_misc.o: src/game_engine_misc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_misc.o src/game_engine_misc.cpp
...
${OBJECTDIR}/src/ui/startup_ui.o: src/ui/startup_ui.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ui/startup_ui.o src/ui/startup_ui.cpp
...
${OBJECTDIR}/sdl_gfx/SDL_imageFilter.o: sdl_gfx/SDL_imageFilter.c 
	${MKDIR} -p ${OBJECTDIR}/sdl_gfx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sdl_gfx/SDL_imageFilter.o sdl_gfx/SDL_imageFilter.c
...
${OBJECTDIR}/src/map_parser.o: src/map_parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/map_parser.o src/map_parser.cpp
...
${OBJECTDIR}/src/config_manager.o: src/config_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/config_manager.o src/config_manager.cpp

${OBJECTDIR}/src/ui/startup_splash_ui.o: src/ui/startup_splash_ui.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ui/startup_splash_ui.o src/ui/startup_splash_ui.cpp
...
${OBJECTDIR}/sqlite/sqlite3.o: sqlite/sqlite3.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sqlite/sqlite3.o sqlite/sqlite3.c

${OBJECTDIR}/src/game_engine_draw.o: src/game_engine_draw.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_draw.o src/game_engine_draw.cpp
...
${OBJECTDIR}/src/config_file.o: src/config_file.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/config_file.o src/config_file.cpp

${OBJECTDIR}/src/game_object.o: src/game_object.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_object.o src/game_object.cpp
...
${OBJECTDIR}/src/message_log.o: src/message_log.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/message_log.o src/message_log.cpp

${OBJECTDIR}/sdl_gfx/SDL_gfxPrimitives.o: sdl_gfx/SDL_gfxPrimitives.c 
	${MKDIR} -p ${OBJECTDIR}/sdl_gfx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sdl_gfx/SDL_gfxPrimitives.o sdl_gfx/SDL_gfxPrimitives.c
...
${OBJECTDIR}/src/game_engine_sound.o: src/game_engine_sound.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_sound.o src/game_engine_sound.cpp
...
${OBJECTDIR}/src/game_engine_gameplay.o: src/game_engine_gameplay.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/game_engine_gameplay.o src/game_engine_gameplay.cpp
...
${OBJECTDIR}/src/text_menu.o: src/text_menu.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/text_menu.o src/text_menu.cpp
